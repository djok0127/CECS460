...
#
# Generated by export_simulation on Tue Mar 19 23:43:56 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './tb_rom.sh' script.
...
./tb_rom.sh -noclean_files

For more information on the script, please type './tb_rom.sh -help'.
