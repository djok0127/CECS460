...
HD_PWD='C:/Users/Chris/Documents/GitHub/CECS_460/ProjectOne_460_blaze/ProjectOne_460_blaze.runs/scratch_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scratch_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scratch_ram.tcl
