...
#
# Generated by export_simulation on Wed Feb 06 23:43:59 -0800 2019
#
################################################################################
...
'-reset_run' switch to the './scratch_ram.sh' script.

./scratch_ram.sh -reset_run
...
./scratch_ram.sh -noclean_files

For more information on the script, please type './scratch_ram.sh -help'.
